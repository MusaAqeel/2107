from fastapi import FastAPI, HTTPException, Depends
    uvicorn.runddleware.cors import CORSMiddleware
...
def get_gpt_recommendations(prompt: str, playlist_length: int) -> dict:
    ...
    and generate song recommendations. Always return a JSON object containing 
    ...
    recommendations = completion.choices[0].message.parsed.model_dump()
